 ...
 */
final class Version20230405130650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oeuvres ADD CONSTRAINT FK_413EEE3EAE784107 FOREIGN KEY (auteurs_id) REFERENCES auteurs (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oeuvres ADD CONSTRAINT FK_413EEE3E60BB6FE6 FOREIGN KEY (auteur_id) REFERENCES auteurs (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
